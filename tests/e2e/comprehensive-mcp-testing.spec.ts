...
test.describe('Complete SaaS Barbershop System - MCP Testing', () => {
  ...
  test('MCP Test 1: Admin God Dashboard - Complete Platform Management', async ({ page }) => {
  ...
  test('MCP Test 2: Complete Barbershop Subscription Flow', async ({ page }) => {
    // Test full subscription signup with Premium plan
    await page.goto('/barbershop-signup');
    
    // Step 1: Select Premium plan
    await page.click('[data-plan="premium"], .cursor-pointer:has-text("Premium")');
    
    // Step 2: Fill barbershop information
    await page.fill('input[placeholder*="Nome da Barbearia"], input[name*="barbershopName"]', 'Barbearia MCP Test');
    await page.fill('input[placeholder*="Proprietário"], input[name*="ownerName"]', 'Proprietário MCP');
    await page.fill('input[placeholder*="Email"], input[name*="email"]', 'mcp@teste.com');
    await page.fill('input[placeholder*="Telefone"], input[name*="phone"]', '(11) 98765-4321');
    await page.fill('input[placeholder*="Endereço"], input[name*="address"]', 'Rua MCP, 200');
    await page.fill('input[placeholder*="Cidade"], input[name*="city"]', 'São Paulo');
  ...
  test('MCP Test 3: Barbershop Dashboard - Complete Feature Testing', async ({ page }) => {
    ...
    await expect(page.locator('button:has-text("Adicionar Barbeiro")')).toBeVisible();
    
    // Test Serviços tab
    await page.click('text=Serviços');
    await expect(page.locator('button:has-text("Adicionar Serviço")')).toBeVisible();
  ...
  test('MCP Test 5: Database Adapter and System Verification', async ({ page }) => {
  ...
  test('MCP Test 6: Plan Comparison and Features Verification', async ({ page }) => {
  ...
  test('MCP Test 9: Responsive Design and Mobile Compatibility', async ({ page }) => {
