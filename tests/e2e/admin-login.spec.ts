...
test.describe("Admin Login and Dashboard", () => {
  ...
  test("should display admin dashboard features - SaaS Platform Management", async ({
    page,
  }) => {
  ...
  test("should be able to navigate between platform management tabs", async ({
    page,
  }) => {
    // Login as admin
    await page.goto("/admin-login");
    ...
    await expect(
      page.locator("text=Todas as barbearias cadastradas na plataforma")
    ).toBeVisible();
  ...
  test("should allow platform admin to view subscription plans", async ({
    page,
  }) => {
    // Login as admin
    await page.goto("/admin-login");
  ...
  test("should allow platform admin to check system status", async ({
    page,
  }) => {
    // Login as admin
    await page.goto("/admin-login");
    ...
    await expect(
      page.locator('button:has-text("Verificar Base de Dados")')
    ).toBeVisible();
    await expect(
      page.locator('button:has-text("Exportar Dados")')
    ).toBeVisible();
