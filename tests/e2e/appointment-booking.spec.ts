...
test.describe("Appointment Booking and Calendar", () => {
  ...
  test("should display booking form with all required fields", async ({
    page,
  }) => {
  ...
  test("should show available time slots for selected date", async ({
    page,
  }) => {
    await page.goto("/booking");
  ...
  test("should allow user to login during booking process", async ({
    page,
  }) => {
    await page.goto("/booking");
