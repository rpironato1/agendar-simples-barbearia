      ...
      try {
        ...
        if (profile?.name && profile?.phone) {
          const { data: clientData } = await supabase
            ...
            .select("id")
            .or(
              `name.eq."${profile.name.replace(/"/g, '\\"')}",phone.eq."${profile.phone.replace(/"/g, '\\"')}"`
            )
            .maybeSingle();
                              ...
                              <div className="flex-1">
                                ...
                                {clientData?.name && (
                                  <p className="text-gray-500 text-sm mt-2">
                                    Cliente: {clientData.name} | Telefone:{" "}
                                    {clientData.phone}
                                  </p>
                                )}
                              </div>
                  ...
                  {totalSpent > 0 && (
                    <div className="mt-6 p-4 bg-amber-500/10 rounded-lg">
                      <p className="text-amber-400 font-semibold">
                        Total investido em cuidados: R$ {totalSpent.toFixed(2)}
                      </p>
                    </div>
                  )}
                </CardContent>
                      ...
                      <div className="p-4 bg-slate-700/30 rounded-lg">
                        ...
                        <p className="text-gray-400 text-sm">
                          {(() => {
                            ...
                            const favoriteBarber = Object.entries(
                              barberCounts
                  ...
                  <div className="grid gap-4">
                    {promotions.length === 0 ? (
                      ...
                      promotions.map((promo) => (
                        <div
                          key={promo.id}
                          className="p-4 bg-gradient-to-r from-purple-500/20 to-amber-500/20 rounded-lg border border-amber-500/30"
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              <h3 className="text-white font-semibold">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300">
                          {barbershopInfo.address.street}
                          <br />
                          {barbershopInfo.address.city} -{" "}
                          {barbershopInfo.address.zipCode}
                        </p>
                        <Button
                          onClick={() =>
                            window.open(
                              `https://maps.google.com?q=${encodeURIComponent(barbershopInfo.address.street + " " + barbershopInfo.address.city)}`,
                              "_blank"
                            )
                          }
                          variant="outline"
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300 mb-3">
                          {barbershopInfo.email}
                        </p>
                        <Button
                          onClick={() =>
                            window.open(
                              `mailto:${barbershopInfo.email}?subject=Contato através do site`,
                              "_blank"
                            )
                          }
                          variant="outline"
                    ...
                    <div className="p-4 bg-slate-700/30 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="text-white">
                            {barbershopInfo.schedule.weekdays}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Sábado</span>
                          <span className="text-white">
                            {barbershopInfo.schedule.saturday}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Domingo</span>
                          <span className="text-red-400">
                            {barbershopInfo.schedule.sunday}
                          </span>
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-300 text-sm">
                                Agendamentos podem ser feitos até 30 minutos
                                antes do fechamento.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="p-4 bg-amber-500/10 rounded-lg border border-amber-500/30">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-300 text-sm">
                                Cancelamentos podem ser feitos até 2 horas antes
                                do horário agendado.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="p-4 bg-green-500/10 rounded-lg border border-green-500/30">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-300 text-sm">
                                Entraremos em contato via WhatsApp para
                        ...
                        <div className="p-4 bg-purple-500/10 rounded-lg border border-purple-500/30">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-300 text-sm">
                                Recomendamos chegar 5 minutos antes do horário
                                agendado.
                              </p>
                            </div>
                          </div>
