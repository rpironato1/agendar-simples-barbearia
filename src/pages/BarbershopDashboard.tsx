...
import { Calendar, Users, Scissors, Settings, Plus, Phone, CheckCircle, XCircle, Clock, DollarSign, TrendingUp, LogOut, UserCheck, CreditCard, Banknote, Smartphone, Store, Crown } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">Painel da Barbearia</h1>
                <p className="text-gray-400 text-sm">{barbershopInfo?.name || 'Elite Barber'}</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              {/* Subscription Badge */}
      ...
      <main role="main" aria-label="Dashboard da barbearia">
        ...
        <Tabs defaultValue="agenda" className="space-y-6">
          <TabsList className="bg-slate-800/50 border border-slate-700">
            ...
            <TabsTrigger value="configuracoes" className="data-[state=active]:bg-amber-500 data-[state=active]:text-black">
          ...
          <TabsContent value="agenda">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Agendamentos da Barbearia</CardTitle>
          ...
          <TabsContent value="financeiro">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Relatório Financeiro</CardTitle>
                <CardDescription className="text-gray-400">
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-white text-2xl font-bold">R$ {monthlyRevenue.toFixed(2)}</p>
                        </div>
                  ...
                  <Card className="bg-slate-700/50 border-slate-600">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-gray-400 text-sm">Agendamentos do Mês</p>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-white text-2xl font-bold">
                            R$ {appointments.length > 0 ? (monthlyRevenue / appointments.length).toFixed(2) : '0.00'}
                          </p>
                        </div>
                ...
                <div className="text-center py-8">
                  <p className="text-gray-400">Relatórios detalhados em desenvolvimento...</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="configuracoes">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Configurações da Barbearia</CardTitle>
                <CardDescription className="text-gray-400">
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-amber-500/10 rounded-lg border border-amber-500/30">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="text-amber-400 font-semibold">Plano Atual: {barbershopInfo?.plan || 'Premium'}</h3>
                        <p className="text-gray-400 text-sm">Status: Ativo</p>
                        <p className="text-gray-400 text-sm">Próxima cobrança: 15/02/2024</p>
                      </div>
                      <Button 
                        variant="outline"
                        className="border-amber-500 text-amber-400 hover:bg-amber-500 hover:text-black"
                  ...
                  {/* Barbershop Info */}
                  <div className="space-y-4">
                    <h3 className="text-white font-semibold">Informações da Barbearia</h3>
                    <div className="grid gap-4">
                      <div>
                        <Label className="text-gray-400">Nome da Barbearia</Label>
                        <Input 
