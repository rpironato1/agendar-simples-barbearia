...
const Booking = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!user) {
      ...
      if (!validateName(sanitizedName)) {
        toast.error(
          "Nome deve conter apenas letras e espaços, com 2-100 caracteres"
        );
        return false;
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (currentUser) {
        ...
        if (userProfile) {
          ...
          const { data: existingClient, error: searchError } = await supabase
            ...
            .select("id, cpf")
            .or(
              `name.eq."${userProfile.name.replace(/"/g, '\\"')}",phone.eq."${userProfile.phone.replace(/"/g, '\\"')}"`
            )
            .maybeSingle();
          ...
          if (existingClient) {
            ...
            if (clientError) {
              console.error(
                "❌ Error creating client for authenticated user:",
                clientError
              );
            ...
            console.log(
              "✅ New client created for authenticated user:",
              clientId
            );
          }
        }
      ...
      toast.success(
        "Agendamento criado com sucesso! Entraremos em contato para confirmar."
      );
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-lg">
              Escolha o melhor horário para cuidar do seu visual
            </p>
          </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      {!isLogin && (
                        <div className="space-y-2">
                          ...
                          />
                          <p className="text-xs text-gray-400">
                            Digite apenas números (11 dígitos) - Campo opcional
                          </p>
                        </div>
                      )}
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-400">
                          {isLogin
                            ...
                            : "Mínimo 6 caracteres (letras, números, símbolos)"}
                        </p>
                      </div>
                    </div>
                  </>
                ...
                <div className="space-y-2">
                  ...
                  {barbersLoading ? (
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("barber", value)
                      }
                    >
                      <SelectTrigger className="bg-slate-700 border-slate-600 text-white">
                    ...
                    <div className="space-y-1 text-gray-300">
                      ...
                      {selectedDate && formData.time && (
                        <p>
                          ...
                          {format(selectedDate, "dd/MM/yyyy")} às{" "}
                          {formData.time}
                        </p>
                      )}
                    </div>
                ...
                >
                  ...
                  {isSubmitting
                    ? "Processando..."
                    : servicesLoading || barbersLoading
                      ? "Carregando..."
                      : user
