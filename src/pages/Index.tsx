...
const services = [
  ...
  },
  {
    ...
    duration: 25,
    price: 25,
    description: "Barba aparada e finalizada com toalha quente",
  },
  {
    id: 3,
    name: "Combo Premium",
  ...
  },
  {
    ...
    duration: 15,
    price: 15,
    description: "Design e aparação de sobrancelhas",
  },
];
...
const testimonials = [
  {
    name: "Carlos Silva",
    rating: 5,
    comment: "Excelente atendimento! Sempre saio satisfeito.",
  },
  {
    name: "João Santos",
    rating: 5,
    comment: "Profissionais top, ambiente acolhedor.",
  },
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-overlay-accessible mb-8 leading-relaxed">
                  Experimente o melhor em cortes masculinos e cuidados com a
                  barba. Profissionais qualificados, ambiente premium e
              ...
              >
                ...
                <Step>
                  <div>
                    ...
                    <p className="text-gray-400">
                      Selecione data e hora disponível
                    </p>
                  </div>
                </Step>
                <Step>
